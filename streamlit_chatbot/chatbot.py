...
steps = [
    ...
    {"content": """
没骗你吧哈哈 怎么样！惊喜吧！我之前说的小惊喜就是这个啊哈哈哈 (电脑比手机效果好) 我之前上课学回来的 那段时间都在搞编程和代码...一直反复修改测试和运行 我能发誓有上百次 哼|||完事我也有在认真学车 也无数次被他们说过 因为不够细节呗 这没看那没看的...有时候说得我都不高兴了啧 那又咋地 接着学呗 开车虽然累但省时啊 我搭车不仅时间长还累 我还是想自个儿独立的哼 等我学会了我就跑了哇哈哈""", "balloons": True},
    {"content": "\" 完事你都不关心我...... \"", "typewriter": True},
    {"content": """
到底是谁会7月中开学才分享5月尾开学发生的事啊...骗你的 那人不会是我 因为我现在就要分享哼|||在学校也不能说我没认识人 但就是差点意思 这认识一点那认识一点这样 约我吃饭我也不好拒绝就应下了 刚认识就一块吃饭好不自在 关键我吃饭慢呢 后面在等我 更不自在了 最后也没吃完 我的评价是还不如我自个儿吃呢...饭对了但人没对也就报吃了...|||有次小组作业（被动成组 老师排的）让弄个视频啥的 包括我四个人 一个啥没干 说放学留不了有小提琴课 一个木木的 像人机 只会问咋搞 一个只输出但不动 晚上我都自己做完摆成品了 因为第二天截止就要交了 她还在提新想法...啊好气 我头一次见这么没用的|||虽然现在变得轻松了很多 但是吧真的好无聊啊 就怪想你们的
""", "balloons": True},
